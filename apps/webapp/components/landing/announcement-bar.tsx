  ...
  return (
    <div className="bg-gray-100 dark:bg-neutral-800 text-center py-2 px-4 border-b border-gray-200 dark:border-neutral-700">
      <p className="text-[11.5px] text-gray-500 dark:text-gray-400">
        <span className="text-gray-900 dark:text-gray-200 font-medium">v0.9 is live</span>
        <span className="mx-2 text-gray-700">&middot;</span>
        Zoom support, recording &amp; playback, real-time transcription, and more
        <Link
          href="https://github.com/Vexa-ai/vexa/releases"
          target="_blank"
