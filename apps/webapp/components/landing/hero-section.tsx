        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="animate-fade-up d3 text-[15.5px] text-gray-500 dark:text-gray-400 leading-[1.7] max-w-[420px]">
              ...
              transcription, bot control, and open APIs for Google Meet,
              Microsoft Teams, and Zoom. Open source, self-hostable, REST + MCP.
            </p>

            {/* CTAs */}
            <div className="animate-fade-up d4 flex flex-col gap-3">
